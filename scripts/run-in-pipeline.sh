...
#      * Default:  True
#
# Example manual docker run within packaged container (git-defenders/detect-secrets-ubi):
#    docker run  --env BASELINE=.secrets.baseline  --env FAIL_ON_LIVE=False  -it -a stdout --rm -v $(pwd):/code git-defenders/detect-secrets-ubi
##
